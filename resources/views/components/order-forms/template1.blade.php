    ...
    <div class="flex flex-col gap-3">
        ...
        <div class="pb-7 mb-3 border-b border-gray-200">
            <ul class="grid w-full gap-6">
                <li class="relative">
                    <input type="radio" id="offer-1" name="offer" value="offer-1" class="hidden peer" required />
                    <label for="offer-1"
                    ...
                    <span class="absolute right-5 -top-2 bg-gray-200 px-5 py-1 text-sm rounded-full font-medium">save
                        25%
                    </span>
                </li>
                <li class="relative">
                    <input type="radio" id="offer-2" name="offer" value="offer-2" class="hidden peer" required />
                    <label for="offer-2"
                        class="inline-flex items-center justify-between w-full p-5 md:p-2 text-gray-500 bg-white border-2 border-gray-200 rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 dark:peer-checked:text-gray-500 peer-checked:bg-gray-100 peer-checked:border-gray-400 peer-checked:text-gray-600 hover:text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                        <div class="flex gap-5 items-center">
                            <img src="https://images.unsplash.com/photo-1592789705501-f9ae4278a9c9?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        ...
        <div class="pb-7 border-b border-gray-200">
            <div class="px-5 border-2 rounded-lg border-gray-400">
                <div class="mt-3">
                    <label for="First name" class="font-medium dark:text-gray-200">
                        First name
                    </label>
                ...
                <div class="mt-3">
                    <label for="Last name" class="font-medium dark:text-gray-200">
                        phone
                    </label>
                ...
                <div class="mt-3">
                    <label for="phone" class="font-medium dark:text-gray-200">
                        Address
                    </label>
            ...
            <div class="flex flex-col gap-3">
                <div
                    ...
                    <div class="flex-1 py-3">
                        ...
                        <label for="bordered-radio-1" class="w-full py-4 ms-2 text-gray-900 dark:text-gray-300">Free
                            Shipping</label>
                    </div>
                    <p class="flex-none font-medium dark:text-gray-200">Free</p>
                </div>
                <div class="flex items-center px-4 border border-gray-200 rounded-lg dark:border-gray-700">
                    ...
                    <p class="flex-none font-medium dark:text-gray-200">30 Dhs</p>
                </div>
            </div>
        </div>
        {{-- prices --}}
        <div class="flex flex-col gap-2">
            <div class="py-1 px-4 flex justify-between dark:text-gray-200">
                <p>Subtotal</p>
                <p>240 Dhs</p>
            </div>
            <div class="px-4 flex justify-between dark:text-gray-200">
                <p>Shipping</p>
                <p>Free</p>
            </div>
            <div class="bg-gray-100 dark:bg-gray-700 dark:text-gray-100 rounded-b-lg py-2 px-4 flex justify-between">
