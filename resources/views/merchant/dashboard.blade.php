    ...
    <div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-6 gap-5">
            <div class="col-span-1 lg:col-span-4">
                {{-- numbers cards --}}
                <x-ui.card class="h-fit overflow-scroll [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]"
                ...
                <x-ui.card class="col-span-2 w-full" header="Products low availability in stock"
                    ...
                    <div class="flex">
                        ...
                        <div class="flex gap-1">
                            <x-ui.badge data-tooltip-target="tooltip-min" data-tooltip-placement="left"
                                style="warning" class="!text-sm">20</x-ui.badge>
                            <div id="tooltip-min" role="tooltip"
                                class="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
                                minimum quantity before alert
                                <div class="tooltip-arrow" data-popper-arrow></div>
                            </div>
                            <x-ui.badge data-tooltip-target="tooltip-curr" data-tooltip-placement="left"
                                style="error" class="!text-sm">15</x-ui.badge>
