...
<div class="lg:mx-auto xl:w-3/4">
        ...
        <div class="grid gap-3 grid-cols-1 lg:grid-cols-4">
            ...
            <div id="default-tab-content" class="md:col-span-3">
                <div class="p-6 bg-gray-50 text-medium text-gray-500 dark:text-gray-400 dark:bg-gray-800 rounded-lg w-full"
                    ...
                    <div class="mx-auto w-3/4">
                        ...
                        <div class="mb-4 flex gap-5 items-center justify-center">
                            <p class="mb-2">Create your first simple or variable product, with cost and sell price so
                                you
                                will
                        ...
                        <a href="#" class="py-2 px-3 text-white text-sm bg-primary rounded-lg">Add Product</a>
                ...
                <div class="hidden p-5 md:p-6 bg-gray-50 text-medium text-gray-500 dark:text-gray-400 dark:bg-gray-800 rounded-lg w-full"
                    ...
                    <div class="mx-auto w-3/4">
                        <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2">Integrate your Woo, Shopify or
                            YouCan store</h3>
                        <div class="mb-4 flex gap-5 items-center justify-center">
                            <p class="mb-2">Syncronise your orders automatically from your store, you can link your
                                Wordpress, Shopify or YouCan store, COD Rocket will import products and orders in real
                                time.
                            </p>
                ...
                <div class="hidden p-6 bg-gray-50 text-medium text-gray-500 dark:text-gray-400 dark:bg-gray-800 rounded-lg w-full"
                    ...
                    <div class="mx-auto w-3/4">
                        <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2">Add your business information
                        </h3>
                        <div class="mb-4 flex gap-5 items-center justify-center">
                        ...
                        <a href="#" class="py-2 px-3 text-white text-sm bg-primary rounded-lg">Add Deliverer</a>
                    </div>
                </div>
                <div class="hidden p-6 bg-gray-50 text-medium text-gray-500 dark:text-gray-400 dark:bg-gray-800 rounded-lg w-full"
                    id="deliverer" role="tabpanel" aria-labelledby="deliverer-tab">
                    <div class="mx-auto w-3/4">
                        <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2">Add your delivery company or
                            your delivery men.</h3>
                        <div class="mb-4 flex gap-5 items-center justify-center">
                            <p class="mb-2">You have a delivery company, or delivery man?add them to your partners
                ...
                <div class="hidden p-6 bg-gray-50 text-medium text-gray-500 dark:text-gray-400 dark:bg-gray-800 rounded-lg w-full"
                    ...
                    <div class="mx-auto w-3/4">
                        <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2">Add your fist order manually
                        </h3>
                        <div class="mb-4 flex gap-5 items-center justify-center">
                            <p class="mb-2">Creating an order is easy, all you need is the customer's phone number,
    ...
    {{-- video section --}}
    <div class="p-6 bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700 mt-5">
